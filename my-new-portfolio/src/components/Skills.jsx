      ...
      >
        {skills.map((skill) => (
          <motion.div
            ...
            className={`flex flex-col items-center justify-center p-6 bg-slate-800/50 backdrop-blur-lg rounded-lg border border-slate-300/10 shadow-lg transform hover:scale-110 hover:border-blue-500/50 transition-all duration-300 group`}
          >
